...
# игровой клип <- анимация Meshy. Принцип: спокойные универсальные клипы
# для тихих сцен, яркие — только для настоящих пиков (успех, финал).
CLIP_MAP = {
    'IdleSad': 'Idle_3',                    # просто стоит (запрос заказчика)
    'IdleOpen': 'Stand_and_Chat',           # открытая живая стойка
    'Walk': 'Walking',
    'SitAlone': 'Look_Back_and_Sit',        # avoidant-ветка: садится
    'NoticeSmile': 'Stand_and_Chat',
    'SmallWave': 'Wave_for_Help_4',         # машет издалека
    'WelcomeGesture': 'Jump_with_Arms_Open',
    'HandToChest': 'Idle_3',                # тихое принятие — без жестикуляции
    'BrightenMakeRoom': 'Stand_and_Chat',
    'TryJoinClumsy': 'Look_Around_Dumbfounded',  # неловкая попытка: растерянность
    'RollOffCourse': 'Backflip_Jump',
    'TryAgainSucceed': 'Jump_with_Arms_Open',    # пик: успех
    'PlayQuiet': 'Stand_and_Chat',
    'PlayIncluded': 'Hip_Hop_Dance_2',           # пик: финальная игра вместе
