...
(-3,-11.6), качели (4.4,-12.6), песочница (7.4,-9.4), друзья
(4.6,-8.6) полукругом, Бруно (-3,-8) rot π/6. Юг: скамейка (6.2,8.6), фонтан
...
поперечная фонтан→лавка (cols -6..5, row 8; фонтан стоит на мощёном
пятачке перекрёстка), ПЕРИМЕТР вдоль забора (rows/cols -14 и 13).
Лавка rot -90 — ровно вдоль дорожки. Клумба на юге (центр ~0.2,11.5):
Flower0..12 — тонированные копии ромашек (розовый/голубой/белый),
тонировка Mix-MULTIPLY в материале (build_environment2.py).
...
менять раскладку = менять ОБА места. Друзья: ПОЛУКРУГ лицом к камере,
группа (4.6,-8.6), yellow(-1.15,0.15)/pink(0,0.75)/red(1.15,0.1),
yaw 0.35/0/-0.35 (yaw 0 = мордой на юг/камеру).
